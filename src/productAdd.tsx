...
interface Product { name: string; description: string; price: number; category: string; tags: string[]; use: string; minimumQuantity: number; sellingPrice: number; addedBy: string; expiresAt: string; quantityOnHand: number; reservedQuantity: number; discount: number; imageUrls: string[];}
...
export function ProductAdd () {
  ...
  const addImageUrl = () => { 
    ...
    return (
      <>
       <Button onClick={open} variant='outline' leftSection={<IconSquareRoundedPlus size={18} />}>Add Product</Button>
